        ...
        while (!option.equals("3")) { 
        	...
        	// Read in the user option selection            
        		...
        		case "1": 
                    ...
                    sc.nextLine();
                    final String fname = sc.nextLine();
                    // Read in user input of student First Name (white-spaces allowed).                    
                    System.out.println("Please enter student last name:");
                    // No need to call nextLine extra time here, because the preceding nextLine consumed the newline character.                    
                    final String lname = sc.nextLine();
                    // Read in user input of student Last Name (white-spaces allowed).                    
                    System.out.println("Please enter float student GPA:");
                    final float gpa = sc.nextFloat();
                    // Read in user input of student GPA                    
                    System.out.println("Please enter student major:");
                    sc.nextLine();
                    // Consuming the trailing new line character left after nextFloat                    
                    final String major = sc.nextLine();
                    // Read in user input of student Major                    
                    System.out.println("Please enter student classification (Freshman, Sophomore, Junior, or Senior):");
                    final String classification = sc.nextLine();
                    // Read in user input of student Classification                    
